...
public class JobSeeker_SignIn_Steps {
    WebDriver driver;
    index_page ip = new index_page(BaseClass.getDriver()); //node
    SignInAsJobSeeker sijs = new SignInAsJobSeeker(BaseClass.getDriver());
    OTP_VerificationPage otp= new OTP_VerificationPage(BaseClass.getDriver());
